...
export const scoreClarityVersion = '2026-09-12.score-clarity2';
...
export async function repairScoreClarity(options, result, run) {
  ...
  if (
    ...
    beforeText.some(
      (text, index) => !indices.has(index) && text !== afterText[index],
    )
  )
