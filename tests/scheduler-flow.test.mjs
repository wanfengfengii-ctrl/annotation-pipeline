...
const schema=a[a.indexOf('--output-schema')+1],out=a[a.indexOf('--output-last-message')+1],stage=['generate','policy','prepare','snapshot','score','delivery','next'].find(s=>schema.endsWith('.'+s+'.schema.json'));
