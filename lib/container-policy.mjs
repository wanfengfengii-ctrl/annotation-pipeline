...
export const previousWebdepsImage =
  'annotation-pipeline/claude-code:2.1.266-webdeps-20260910';
export const containerImage =
  'annotation-pipeline/claude-code:2.1.266-webdeps-cache2-20260910';
...
export const containerImagePolicy = '2026-09-10.webdeps-cache2';
...
export function validDockerSnapshot(value) {
  ...
  return (
    ...
    [
      containerImage,
      previousWebdepsImage,
      previousContainerImage,
      legacyContainerImage,
    ].some((image) => value === 'docker://' + image + '@' + digest)
  );
}
