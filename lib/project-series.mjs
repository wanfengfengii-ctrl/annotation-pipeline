...
export function shouldFinishSession(task) {
  ...
  if (turn.status === 'failed' && !turn.excluded) return false;
  return !!(
    task.closed ||
    turn.excluded ||
    turn.sessionFinished ||
