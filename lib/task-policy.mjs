...
function validatePolicyAudit(
  ...
  digest,
  {
    ...
    expectedQuestionRuleVersion = questionRules.version,
  } = {},
) {
  const v = audit?.value;
  if (
  ...
  if (requireQuestionStyle || audit.questionRuleVersion) {
    if (audit.questionRuleVersion !== expectedQuestionRuleVersion)
